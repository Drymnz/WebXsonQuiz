    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 87: break;
          case 24:
            { print("xml"); return new Symbol(MySymSQLKV.XML ,yyline,yycolumn,yytext());
            }
          // fall through
          case 88: break;
          case 25:
          ...
          case 89: break;
          case 26:
            { print("xson"); return new Symbol(MySymSQLKV.XSON ,yyline,yycolumn,yytext());
            }
          // fall through
          case 90: break;
          case 27:
          ...
          case 94: break;
          case 31:
            { print("version"); return new Symbol(MySymSQLKV.VERSION ,yyline,yycolumn,yytext());
            }
          // fall through
          case 95: break;
          case 32:
          ...
          case 101: break;
          case 38:
            { print("\"PASSWORD\""); return new Symbol(MySymSQLKV.PASS_USER ,yyline,yycolumn,yytext());
            }
          // fall through
          case 102: break;
          case 39:
          ...
          case 106: break;
          case 43:
            { print("\"NUEVA_TRIVIA\""); return new Symbol(MySymSQLKV.NEW_TRIVIA ,yyline,yycolumn,yytext());
            }
          // fall through
          case 107: break;
          case 44:
            { print("\"DATOS_USUARIO\""); return new Symbol(MySymSQLKV.USER_DATA ,yyline,yycolumn,yytext());
            }
          // fall through
          case 108: break;
          case 45:
          ...
          case 109: break;
          case 46:
            { print("\"USUARIO_NUEVO\""); return new Symbol(MySymSQLKV.NEW_USER ,yyline,yycolumn,yytext());
            }
          // fall through
          case 110: break;
          case 47:
          ...
          case 111: break;
          case 48:
            { print("\"NUEVO_PASSWORD\""); return new Symbol(MySymSQLKV.NUEVO_PASSWORD ,yyline,yycolumn,yytext());
            }
          // fall through
          case 112: break;
          case 49:
            { print("\"ELIMINAR_TRIVIA\""); return new Symbol(MySymSQLKV.ELIMINAR_TRIVIA ,yyline,yycolumn,yytext());
            }
          // fall through
          case 113: break;
          case 50:
          ...
          case 114: break;
          case 51:
            { print("\"USUARIO_ANTIGUO\""); return new Symbol(MySymSQLKV.USUARIO_ANTIGUO ,yyline,yycolumn,yytext());
            }
          // fall through
          case 115: break;
          case 52:
            { print("\"ELIMINAR_USUARIO\""); return new Symbol(MySymSQLKV.ELIMINAR_USUARIO  ,yyline,yycolumn,yytext());
            }
          // fall through
          case 116: break;
          case 53:
            { print("\"MODIFICAR_TRIVIA\""); return new Symbol(MySymSQLKV.MODIFICAR_TRIVIA ,yyline,yycolumn,yytext());
            }
          // fall through
          case 117: break;
          case 54:
          ...
          case 118: break;
          case 55:
            { print("realizar_solicitud"); return new Symbol(MySymSQLKV.MAKE_REQUEST ,yyline,yycolumn,yytext());
            }
          // fall through
          case 119: break;
          case 56:
            { print("\"MODIFICAR_USUARIO\""); return new Symbol(MySymSQLKV.MODIFICAR_USUARIO  ,yyline,yycolumn,yytext());
            }
          // fall through
          case 120: break;
          case 57:
            { print("\"PARAMETROS_TRIVIA\""); return new Symbol(MySymSQLKV.PARAMETROS_TRIVIA ,yyline,yycolumn,yytext());
            }
          // fall through
          case 121: break;
          case 58:
            { print("\"AGREGAR_COMPONENTE\""); return new Symbol(MySymSQLKV.AGREGAR_COMPONENTE ,yyline,yycolumn,yytext());
            }
          // fall through
          case 122: break;
          case 59:
            { print("realizar_solicitudes"); return new Symbol(MySymSQLKV.MAKE_REQUESTS ,yyline,yycolumn,yytext());
            }
          // fall through
          case 123: break;
          case 60:
            { print("\"ELIMINAR_COMPONENTE\""); return new Symbol(MySymSQLKV.ELIMINAR_COMPONENTE ,yyline,yycolumn,yytext());
            }
          // fall through
          case 124: break;
          case 61:
            { print("\"MODIFICAR_COMPONENTE\""); return new Symbol(MySymSQLKV.MODIFICAR_COMPONENTE ,yyline,yycolumn,yytext());
            }
          // fall through
          case 125: break;
          case 62:
            { print("\"PARAMETROS_COMPONENTE\""); return new Symbol(MySymSQLKV.PARAMETROS_COMPONENTE ,yyline,yycolumn,yytext());
            }
          // fall through
          case 126: break;
          case 63:
            { print("fin_solicitud_realizada"); return new Symbol(MySymSQLKV.FINAL_REQUEST ,yyline,yycolumn,yytext());
            }
          // fall through
          case 127: break;
          case 64:
            { print("fin_solicitudes_realizada"); return new Symbol(MySymSQLKV.FINAL_REQUESTS ,yyline,yycolumn,yytext());
            }
          // fall through
          case 128: break;
          default:
